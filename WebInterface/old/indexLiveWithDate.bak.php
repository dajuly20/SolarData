 ...
 <style>
  ...
  <script type="text/javascript">
   ...
   // });
	...
	var storedData = 	[["2018-05-10 20:50:27", 6.36], ["2018-05-10 20:50:28", 6.5], ["2018-05-10 20:50:29", 6.7]];
	var storedVoltage = [["2018-05-10 20:50:27", 4], ["2018-05-10 20:50:28", 7], ["2018-05-10 20:50:29", 9]];
	var storedCur = 	[["2018-05-10 20:50:27", 8], ["2018-05-10 20:50:28", 15], ["2018-05-10 20:50:29", 3]];
	var storedChg = 	[["2018-05-10 20:50:27", 14], ["2018-05-10 20:50:28", 13], ["2018-05-10 20:50:29",12]];
    ...
    //if (newData.length) {
		...
		$.getJSON( "query.php?show="+what+"&date="+date+"&tNum="+tNum, function( data ) {
			...
			if(typeof data.err !== 'undefined' && data.err[1] != ""){
				...
				var newVal  = data.res[0][0].slice(); /* update storedData array*/
				var newVolt = data.res[1][0].slice();
				var newCur  = data.res[2][0].slice();
				//console.log(newCur);
